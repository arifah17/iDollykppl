                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <?php foreach ($data as $x) { ?>
                                    <tr >
                                        ...
                                        <td><?= $x['harga'] ?></td>
                                        <td><?= $x['nama_cat'] ?></td>
                                        <td><img style="width: 250px; height: 200px;"src="<?php echo base_url()."upload/".$x['gambar']?>"></td>
                                        <td><a href="<?php echo base_url()."index.php/product/do_update/".$x['id']; ?>">Edit</a> || <a href="<?php echo base_url()."index.php/product/do_delete/".$x['id']; ?>">Delete</a></td>
                                    </tr>
                                <?php } ?>
                                </tbody>
                            </table>
